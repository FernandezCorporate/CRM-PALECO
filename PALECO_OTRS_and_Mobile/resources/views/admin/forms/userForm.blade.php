...
<div class="max-w-4xl text-slate-800 pb-12">
    ...
    <div class="mb-8">
        ...
        <p class="text-sm text-slate-500 mt-1">
            @if(isset($user))
                Update profile information or modify operational assignments for <span class="font-bold text-slate-700">{{ $user->username }}</span>.
            @else
                Create a new system account and assign their operational roles.
            @endif
        </p>
    </div>

    <form action="{{ isset($user) ? route('admin.updateUser', $user->id) : route('admin.addUser') }}" method="POST" class="space-y-10" autocomplete="off">
        @csrf
        @if(isset($user))
            @method('PUT')
        @endif
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="first_name" value="{{ old('first_name', $user->first_name ?? '') }}" required maxlength="255" placeholder="e.g. Juan" class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm placeholder-slate-300">
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="text" name="middle_name" value="{{ old('middle_name', $user->middle_name ?? '') }}" maxlength="255" placeholder="e.g. M" class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm placeholder-slate-300">
                </div>
                <div class="md:col-span-2 md:col-start-1">
                    ...
                    <input type="text" name="last_name" value="{{ old('last_name', $user->last_name ?? '') }}" required maxlength="255" placeholder="e.g. Dela Cruz" class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm placeholder-slate-300">
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="text" name="name_ext" value="{{ old('name_ext', $user->name_ext ?? '') }}" maxlength="10" placeholder="e.g. Jr." class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm placeholder-slate-300">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="username" value="{{ old('username', $user->username ?? '') }}" required maxlength="255" autocomplete="off" placeholder="e.g. jdelacruz" class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm placeholder-slate-300">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="email" name="email" value="{{ old('email', $user->email ?? '') }}" maxlength="255" autocomplete="off" placeholder="e.g. juan.delacruz@example.com" class="w-full md:w-[calc(50%-12px)] px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm placeholder-slate-300">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="time" name="shift_start" value="{{ old('shift_start', isset($user) && $user->shift_start ? \Carbon\Carbon::parse($user->shift_start)->format('H:i') : '') }}" class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm">
                </div>
                <div>
                    <label class="block text-xs font-bold text-slate-600 uppercase mb-1.5">Shift End</label>
                    <input type="time" name="shift_end" value="{{ old('shift_end', isset($user) && $user->shift_end ? \Carbon\Carbon::parse($user->shift_end)->format('H:i') : '') }}" class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 bg-white shadow-sm">
                </div>
            </div>
        </div>
