...
<body class="h-full flex items-center justify-center p-4 md:p-6 select-none">
        ...
        <div class="w-full md:w-[55%] p-8 md:p-12 flex flex-col justify-center">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <!-- CWD Officer Card -->
                    <div id="card-cwd_officer" onclick="selectRole('cwd_officer')" class="role-card p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 flex flex-col justify-between h-24 border-slate-200 hover:border-slate-300 bg-white group">
                        <div id="icon-cwd_officer" class="w-7 h-7 rounded-lg flex items-center justify-start text-slate-400 group-hover:text-slate-600 transition-colors">
    ...
    function selectRole(role) {
        ...
        document.getElementById('icon-cwd_officer').classList.replace('text-[#10a352]', 'text-slate-400');
